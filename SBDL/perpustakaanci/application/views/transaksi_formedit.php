    ...
    <article class="card-body mx-auto" style="max-width: 400px;">
        ...
        <table>
            <tr>
                ...
                <td>
                    <div class="form-group input-group">                            
                        <input name="id_transaksi" class="form-control"  type="number" value="<?php echo $u->id_transaksi ?>">
                    </div> <!-- form-group// -->
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group input-group">                            
                        <input name="id_siswa" class="form-control"  type="number" value="<?php echo $u->id_siswa ?>">
                    </div> <!-- form-group// -->            
                </td>
            </tr>
            <tr>
                ...
                <td>                        
                    <div class="form-group input-group">                                    
                        <input name="tgl_pinjam" class="form-control" type="date" value="<?php echo $u->tgl_pinjam ?>">
                    </div> <!-- form-group// -->            
                </td>
            </tr>
            <tr>
                ...
                <td>                            
                    <div class="form-group input-group">                                
                        <input class="form-control" name="tgl_kembali" type="date" value="<?php echo $u->tgl_kembali ?>">
                    </div> <!-- form-group// -->                   
                </td>
            </tr>
            <tr>
