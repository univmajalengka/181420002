...
<div class="content">
  <div class="row">
    ...
    <article class="card-body mx-auto" style="max-width: 400px;">
        <h4 class="card-title mt-3 text-center">Edit buku</h4>
        ...
        <form class="form-signin" action="<?php echo site_url('homeadmin/update_buku') ?>" method="post">
        <table>
            <tr>
                <td>
                    Id buku
                ...
                <td>
                  <div class="form-group input-group">
                      <input name="id_buku" class="form-control"  type="text" value="<?php echo $u->id_buku ?>">
                  </div> <!-- form-group// -->
                </td>
            </tr>
            <tr>
                ...
                <td>
                <div class="form-group input-group">
                   <input name="judul" class="form-control"  type="text" value="<?php echo $u->judul ?>">
                </div> <!-- form-group// -->
                </td>
            </tr>
            <tr>
                ...
                <td>
                  <div class="form-group input-group">
                    <input name="pengarang" class="form-control"  type="text" value="<?php echo $u->pengarang ?>">
                  </div> <!-- form-group// -->            
                </td>
            </tr>
            <tr>
                ...
                <td>
                  <div class="form-group input-group">
                    <input name="tgl" class="form-control"  type="text" value="<?php echo $u->tgl ?>">
                  </div> <!-- form-group// -->            
                </td>
            </tr>
            <tr>
                ...
                <td>                        
                <div class="form-group input-group">                                    
                      <input name="jml" class="form-control" type="number" value="<?php echo $u->jml ?>">
                  </div> <!-- form-group// -->            
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                  <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-block">Edit Buku</button>
                  </div> <!-- form-group// -->                  
                </td>
            </tr>
        </table>
