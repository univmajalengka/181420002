  ...
  <div class="row">
    <!-- <div class="col s12 l4 m4"> -->
      ...
      <div class="container">
        ...
        <thead>
        <a href="<?php echo site_url('homeadmin/tambah_buku') ?>" class="btn btn-primary btn-xs pull-right"><b>+</b> Add new Buku</a>
            <tr>
                <th>ID Buku</th>
                <th>Judul</th>
                <th>Pengarang</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><a class='btn btn-info btn-xs' href="<?php echo site_url('homeadmin/edit_buku/') .$b->id_buku ?>"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
                    <a href="<?php echo site_url('homeadmin/hapus_buku/') .$b->id_buku ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a></td>
                </tr>
                <?php } ?>
        </table>
        </div>
