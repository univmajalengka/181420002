...
<title>My profil</title>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/myprofil-css.css">
        ...
        <thead>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><a class='btn btn-info btn-xs' href="<?php echo site_url('homepage/update_buku') ?>"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
