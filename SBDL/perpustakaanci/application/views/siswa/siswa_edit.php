<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('siswa/edit/'.$edit['nis']); ?>">Siswa</a></li>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('siswa/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php if($edit['image'] != '') { ?>
                            <img src="<?php echo base_url('assets/img/siswa/'.$edit['image']);?>" width="100px" height="100px">
                        <?php }else{ ?>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="btn-group pull-left">
                            <?php echo anchor('siswa', 'Cancel', array('class' => 'btn btn-danger btn-sm')); ?>
                        </div>
                    </div>
                    <div class="col-sm-6">
