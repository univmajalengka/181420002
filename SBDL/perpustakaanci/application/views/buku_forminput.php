...
<div class="content">
  <div class="row">
    ...
    <article class="card-body mx-auto" style="max-width: 400px;">
        <h4 class="card-title mt-3 text-center">Create Buku</h4>
        
      
        <p class="divider-text">
            <span class="bg-light">*</span>
        </p>
        <form class="form-signin" action="<?php echo site_url('homeadmin/tambah_aksi_buku') ?>" method="post">
        <div class="form-group input-group">
            <input name="id_buku" class="form-control" placeholder="ID_Buku" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
            <input name="judul" class="form-control" placeholder="Judul" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
            <input name="pengarang" class="form-control" placeholder="pengarang" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
        ...
        <div class="form-group input-group">
            <input name="jml" class="form-control" placeholder="jml" type="number">
        </div> <!-- form-group// -->
        
         <div class="form-group">
            <button type="submit" class="btn btn-primary btn-block">Create Buku</button>
        </div> <!-- form-group// -->      
