...
<div class="content">
  <div class="row">
    ...
    <article class="card-body mx-auto" style="max-width: 400px;">
        <h4 class="card-title mt-3 text-center">Create Transaksi</h4>
        <p class="divider-text">
            <span class="bg-light">*</span>
        </p>
        <form class="form-signin" action="<?php echo site_url('homeadmin/tambah_aksi_transaksi') ?>" method="post">
        <div class="form-group input-group">
            <input name="id_buku" class="form-control" placeholder="Id Buku" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
            <input name="judul" class="form-control" placeholder="Judul Buku" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
