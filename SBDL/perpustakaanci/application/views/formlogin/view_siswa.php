    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li  class="active"><a href="<?php echo site_url('login/view_siswa');?>"><i class="glyphicon glyphicon-user"></i> Siswa</a></li>
            </ul>
            <div class="nav navbar-nav navbar-right">
                <form class="navbar-form navbar-right" role="search" action="<?php echo site_url('login/search_siswa');?>" method="post">
                    <div class="form-group">
                        <input type="text" name="cari_siswa" class="form-control" placeholder="Search Member">
                    </div>
