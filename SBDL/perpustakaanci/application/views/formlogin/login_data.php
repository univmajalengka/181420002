    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo site_url('login/view_siswa');?>"><i class="glyphicon glyphicon-user"></i> Siswa</a></li>
            </ul>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4> SENIOR HIGH SCHOOL</h4><hr class="line-title"> 
        <img src="<?php echo base_url(); ?>assets/img/banner/img-banner.jpg" alt="Belum Tersedia" class="img-responsive">
    </div>
</div>
</div>
